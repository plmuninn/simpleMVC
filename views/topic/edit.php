...
<fieldset>
    ...
    <form method="post">
        ...
        <label for="name">Nazwa: </label><input id="name" type="text" name="name"
                                                value="<?php echo $edit_topic->title;?>"/><br/>
        <br/>
        <label for="value">Treść: </label><textarea id="value" rows="10" cols="40"
                                                    name="value"><?php echo $first_post->value; ?></textarea><br/>
        <?php
        if (Application::isAdmin()) {
