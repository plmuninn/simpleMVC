...
<fieldset>
    ...
    <form method="post" action="<?php echo $this->app->getHomeUrl()?>index.php?url=admin/add&comp=blog">
        ...
        <label>Treść krótka:</label><textarea rows="5" cols="40" name="short"><?php echo (isset($topic)? $topic->short : ""); ?></textarea><br />
        <label>Treść długa:</label><textarea rows="10" cols="40" name="long"><?php echo (isset($topic)? $topic->long : ""); ?></textarea><br />
