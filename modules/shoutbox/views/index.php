...
<div class="box" style="display: none">
    ...
    <div class="shoutbox">
        ...
        <input type="text" value="Wpisz wiadomość" name="shout_name" id="shout_message"
               onblur="if (this.value == '') {this.value = 'Wpisz wiadomość';}"
               onfocus="if (this.value == 'Wpisz wiadomość') {this.value = '';}"/>
